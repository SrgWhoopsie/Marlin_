 ...
 */
  ...
  #define THERMAL_PROTECTION_BED_PERIOD        60 // Seconds                                //WHoopsie
...
#define HOTEND_IDLE_TIMEOUT                        //Whoopsie
  ...
  #define HOTEND_IDLE_TIMEOUT_SEC (10*60)    // (seconds) Time without extruder movement to trigger protection                        //Whoopsie
  #define HOTEND_IDLE_MIN_TRIGGER   160     // (°C) Minimum temperature to enable hotend protection                                   //Whoopsie
  #define HOTEND_IDLE_NOZZLE_TARGET   50     // (°C) Safe temperature for the nozzle after timeout                                    //Whoopsie
...
#define USE_CONTROLLER_FAN                                                                                     //Whoopsie
  ...
  #define CONTROLLER_FAN_PIN PC7      // Set a custom pin for the controller fan                               //Whoopsie
  // #define CONTROLLER_FAN2_PIN FAN2_PIN          // Set a custom pin for second controller fan
  ...
  #define CONTROLLERFAN_IDLE_TIME        300 // (seconds) Extra time to keep the fan running after disabling motors       //Whoopsie
 ...
 */
#define FAN_KICKSTART_TIME  2500  // (ms)                        //Whoopsie
#define FAN_KICKSTART_POWER 190  // 64-255                       //Whoopsie
 ...
 */
#define E0_AUTO_FAN_PIN PB15                                     //Whoopsie
...
#define EXTRUDER_AUTO_FAN_TEMPERATURE 70                        //Whoopsie
...
// #define ASSISTED_TRAMMING                        //Whoopsie
  ...
  #define TRAMMING_POINT_XY { {  30, 30 }, { 190,  30 }, { 190, 190 }, { 30, 190 } }                        //Whoopsie
   ...
   */
  #define TRAMMING_SCREW_THREAD 40                        //Whoopsie
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 60*60, 60*60, 8*60, 6*60 } // (mm/min) Feedrates for manual moves along X, Y, Z, E from panel
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_5X_STEPS_PER_SEC    30  // (steps/s) Encoder rate for 5x speed                         //Whoopsie
  #define ENCODER_10X_STEPS_PER_SEC   80  // (steps/s) Encoder rate for 10x speed                        //Whoopsie
  #define ENCODER_100X_STEPS_PER_SEC 130  // (steps/s) Encoder rate for 100x speed                       //Whoopsie
#endif
...
//#define LCD_BACKLIGHT_TIMEOUT_MINS 1  // (minutes) Timeout before turning off the backlight
  ...
  #define STATUS_MESSAGE_TIMEOUT_SEC 120 // (seconds)                        //Whoopsie
  ...
  #define LED_CONTROL_MENU                        //Whoopsie
    ...
    #define NEO2_COLOR_PRESETS              // Enable a second NeoPixel Preset Color menu option                       //Whoopsie
    #if ENABLED(LED_COLOR_PRESETS)
      #define LED_USER_PRESET_RED        200  // User defined RED value                       //Whoopsie
      #define LED_USER_PRESET_GREEN      200  // User defined GREEN value                       //Whoopsie
      #define LED_USER_PRESET_BLUE       200  // User defined BLUE value                       //Whoopsie
      #define LED_USER_PRESET_WHITE      0  // User defined WHITE value                       //Whoopsie
      #define LED_USER_PRESET_BRIGHTNESS 200  // User defined intensity                       //Whoopsie
      //#define LED_USER_PRESET_STARTUP       // Have the printer display the user preset color on startup
    #endif
    #if ENABLED(NEO2_COLOR_PRESETS)
      #define NEO2_USER_PRESET_RED        200 // User defined RED value                       //Whoopsie
      #define NEO2_USER_PRESET_GREEN      50 // User defined GREEN value                       //Whoopsie
      #define NEO2_USER_PRESET_BLUE       180 // User defined BLUE value                       //Whoopsie
      #define NEO2_USER_PRESET_WHITE      0 // User defined WHITE value                       //Whoopsie
      #define NEO2_USER_PRESET_BRIGHTNESS 200 // User defined intensity                       //Whoopsie
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   */
  #define SDCARD_SORT_ALPHA                       //Whoopsie

  // SD Card Sorting options
  #if ENABLED(SDCARD_SORT_ALPHA)
    #define SDSORT_REVERSE     false  // Default to sorting file names in reverse order.
    #define SDSORT_LIMIT       50     // Maximum number of sorted items (10-256). Costs 27 bytes each. //Whoopsie
    #define SDSORT_FOLDERS     -1     // -1=above  0=none  1=below
    #define SDSORT_GCODE       true  // Enable G-code M34 to set sorting behaviors: M34 S<-1|0|1> F<-1|0|1> //Whoopsie
    #define SDSORT_USES_RAM    true  // Pre-allocate a static array for faster pre-sorting. //Whoopsie
    #define SDSORT_USES_STACK  false  // Prefer the stack for pre-sorting to give back some SRAM. (Negated by next 2 options.)
    #define SDSORT_CACHE_NAMES true  // Keep sorted items in RAM longer for speedy performance. Most expensive option.
    #define SDSORT_DYNAMIC_RAM true  // Use dynamic allocation (within SD menus). Least expensive option. Set SDSORT_LIMIT before use!                        //Whoopsie
...
#define TX_BUFFER_SIZE 64                        //Whoopsie
...
#define ADVANCED_PAUSE_FEATURE                       //Whoopsie
  ...
  #define PAUSE_PARK_RETRACT_LENGTH            4  // (mm) Initial retract.                       //Whoopsie
                                                  // This short retract is done immediately, before parking the nozzle.
  #define FILAMENT_CHANGE_UNLOAD_FEEDRATE     10  // (mm/s) Unload filament feedrate. This can be pretty fast.
  #define FILAMENT_CHANGE_UNLOAD_ACCEL        25  // (mm/s^2) Lower acceleration may allow a faster feedrate.
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      250  // (mm) The length of filament for a complete unload.                       //Whoopsie
  ...
  #define ADVANCED_PAUSE_PURGE_LENGTH         0  // (mm) Length to extrude after loading.                       //Whoopsie
  ...
  #define FILAMENT_CHANGE_ALERT_BEEPS        100  // Number of alert beeps to play when a response is needed.                       //Whoopsie
  #define PAUSE_PARK_NO_STEPPER_TIMEOUT           // Enable for XYZ steppers to stay powered on during filament change.
  //#define FILAMENT_CHANGE_RESUME_ON_INSERT      // Automatically continue / load filament when runout sensor is triggered again.
  //#define PAUSE_REHEAT_FAST_RESUME              // Reduce number of waits by not prompting again post-timeout before continuing.

  #define PARK_HEAD_ON_PAUSE                    // Park the nozzle during pause and filament change.                       //Whoopsie
 ...
 */
  ...
  #define X_HYBRID_THRESHOLD     80  // [mm/s]                       //Whoopsie
  #define X2_HYBRID_THRESHOLD    80                       //Whoopsie
  #define Y_HYBRID_THRESHOLD     80                       //Whoopsie
  #define Y2_HYBRID_THRESHOLD    80                       //Whoopsie
