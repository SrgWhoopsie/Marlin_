...
//Whoopsie changes by Srg_Whoopsie
...
#define STRING_CONFIG_H_AUTHOR "(Srg_Whoopsie, default config)" // Who made the changes. //Whoopsie
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_BTT_SKR_MINI_E3_V3_0                                       //Whoopsie
#endif
...
#define HEATER_0_MINTEMP   0                                                           //Whoopsie
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    // Aquila X2 //Whoopsie
    #define DEFAULT_Kp  28.72                                                           //Whoopsie
    #define DEFAULT_Ki   2.62                                                           //Whoopsie
    #define DEFAULT_Kd  78.81                                                           //Whoopsie
  #endif
#else
...
#define ENDSTOP_INTERRUPTS_FEATURE                                                 //Whoopsie
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.08 // (mm) Distance from real junction edge           //Whoopsie
 ...
 */
#define S_CURVE_ACCELERATION                                                           //Whoopsie
 ...
 */
// #define Z_MIN_PROBE_USES_Z_MIN_ENDSTOP_PIN                                          //Whoopsie
 ...
 */
#define Z_MIN_PROBE_PIN PC14 // Pin PC14 is the SKR Mini E3 V3.o default               //Whoopsie
...
#define Z_CLEARANCE_BETWEEN_PROBES  3 // (mm) Z Clearance between probe points //Whoopsie
#define Z_CLEARANCE_MULTI_PROBE     3 // (mm) Z Clearance between multiple probes //Whoopsie
#define Z_PROBE_ERROR_TOLERANCE     3 // (mm) Tolerance for early trigger (<= -probe.offset.z + ZPET)//Whoopsie
...
#define HOME_AFTER_DEACTIVATE   // Require rehoming after steppers are deactivated. Also enable NO_MOTION_BEFORE_HOMING for extra safety.  //Whoopsie
...
#define X_BED_SIZE 220                                                                                  //Whoopsie
#define Y_BED_SIZE 220                                                                                  //Whoopsie
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define G26_MESH_VALIDATION                                                                             //Whoopsie
    ...
    #define G26_RETRACT_MULTIPLIER   1.2  // G26 Q (retraction) used by default between mesh test elements.   //Whoopsie
  #endif
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (6*60) }                                                //Whoopsie
...
#define DEFAULT_KEEPALIVE_INTERVAL 5  // Number of seconds between "busy" messages. Set with M113.          //Whoopsie
...
#define PREHEAT_3_LABEL       "Warmup"                                                                      //Whoopsie
#define PREHEAT_3_TEMP_HOTEND 160                                                                           //Whoopsie
#define PREHEAT_3_TEMP_BED     50                                                                           //Whoopsie
#define PREHEAT_3_FAN_SPEED     0                                                                           //Whoopsie
...
//
#define ENCODER_PULSES_PER_STEP 4                                                                           //Whoopsie

//
// Use this option to override the number of step signals required to
// move between next/prev menu items.
//
#define ENCODER_STEPS_PER_MENU_ITEM 1                                                                       //Whoopsie
...
//
#define REVERSE_ENCODER_DIRECTION                                                                           //Whoopsie
...
// #define DWIN_LCD_PROUI              // Pro UI by MRiscoC                                                //Whoopsie
// Professional firmware features:    // Undefine all except SD Extender                                //Whoopsie
// #define ProUIex 1                                                                                       //Whoopsie
#ifdef ProUIex                                                                                          //Whoopsie
  #define HAS_GCODE_PREVIEW 1                                                                           //Whoopsie
  #define HAS_TOOLBAR 1                                                                                 //Whoopsie
  #define HAS_PIDPLOT 1                                                                                 //Whoopsie
  //#define HAS_ESDIAG 1                                                                                //Whoopsie
  #define HAS_CGCODE 1                                                                                  //Whoopsie
  #define HAS_LOCKSCREEN 1                                                                              //Whoopsie
  #define SHOW_REAL_POS 1                                                                               //Whoopsie
  //#define HAS_SD_EXTENDER 1  // Enable it to support SD card extender cables                          //Whoopsie
#elif ENABLED(DWIN_LCD_PROUI)                                                                           //Whoopsie
  #define HAS_GCODE_PREVIEW 1                                                                           //Whoopsie
  #define HAS_PIDPLOT 1                                                                                 //Whoopsie
  #define HAS_ESDIAG 1                                                                                  //Whoopsie
  #define HAS_CGCODE 1                                                                                  //Whoopsie
...
#define NEOPIXEL_LED                                                                                  //Whoopsie
  ...
  #define NEOPIXEL2_SEPARATE  //Whoopsie
    ...
    #define NEOPIXEL2_PIXELS           15 // Number of LEDs in the second strip                       //Whoopsie
    #define NEOPIXEL2_BRIGHTNESS      180 // Initial brightness (0-255)                               //Whoopsie
